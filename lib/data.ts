...
export const SST_TEMPLATE: SimpleTemplate = {
  ...
  label: 'SST 模板',
  parts: [
    { label: '主题句', text: 'The lecture mainly talks about [主题/话题].', slots: ['主题/话题'] },
    { label: '要点一', text: 'Firstly, the speaker mentioned that [第一个要点].', slots: ['第一个要点'] },
    { label: '要点二', text: 'Also, the speaker said that [第二个要点].', slots: ['第二个要点'] },
    { label: '要点三', text: 'Additionally, it was noted that [第三个要点].', slots: ['第三个要点'] },
    { label: '结论句', text: 'In conclusion, the lecture on the topic of [主题] was very informative.', slots: ['主题'] },
  ],
  tips: [
    '字数要求：50–70 words',
    '和 RL / SGD 使用同一套叙述骨架：主题、Firstly、Also、Additionally、In conclusion',
    '边听边记关键词（名词、动词、数字）',
    '不超过4个要点，抓最重要的信息',
    '用自己的词改写，避免直接抄原文',
    '注意人名、地名、专业词汇的拼写',
...
export const SGD_TEMPLATE: SimpleTemplate = {
  ...
  label: 'SGD 模板',
  parts: [
    { label: '主题句', text: 'The discussion mainly talks about [主题/话题].', slots: ['主题/话题'] },
    { label: '要点一', text: 'Firstly, the first speaker mentioned that [第一个观点].', slots: ['第一个观点'] },
    { label: '要点二', text: 'Also, the second speaker said that [第二个观点].', slots: ['第二个观点'] },
    { label: '要点三', text: 'Additionally, another speaker noted that [第三个观点].', slots: ['第三个观点'] },
    { label: '结论句', text: 'In conclusion, the discussion on the topic of [主题] was very informative.', slots: ['主题'] },
  ],
  tips: [
    '时间：10秒准备，90秒录音',
    '和 SST / RL 使用同一套叙述骨架，只把 lecture 改成 discussion',
    '边听边记每位说话者的核心观点，不需要覆盖全部细节',
    '如果只听到两位说话者，第三句可以继续用 the first/second speaker 的补充观点',
    '不需要表达个人观点，只需客观总结',
    '总结句回到总主题即可，不需要复杂评价',
  ],
}
...
export const RL_TEMPLATE: SimpleTemplate = {
  ...
  tips: [
    '时间：10秒准备，40秒录音',
    '和 SST 使用同一套 lecture 叙述，口语时说得流畅即可',
    '边听边在草稿纸上记3-5个关键词',
    '不需要复述所有细节，抓主旨和1-2个要点即可',
    '开头句要清晰说出 "The lecture mainly talks about..."',
    '用过去时（mentioned, said, noted）',
    '流畅度比内容量更重要',
  ],
}
