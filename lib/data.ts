...
export const DI_TYPE_TEMPLATES: DITypeTemplate[] = [
  {
    ...
    parts: [
      ...
      { label: 'X 轴', template: 'The x-axis talks about [X轴内容].', slots: ['X轴内容'] },
      { label: 'Y 轴', template: 'The y-axis talks about [Y轴内容] across [N] different categories such as [类别列表].', slots: ['Y轴内容', 'N', '类别列表'] },
      { label: '细节一', template: 'It is evident that [最显著的数据点].', slots: ['最显著的数据点'] },
      { label: '细节二', template: '[第二个数据观察].', slots: ['第二个数据观察'] },
      { label: '细节三', template: 'And [第三个数据观察].', slots: ['第三个数据观察'] },
      { label: '总结', template: 'Overall, this image talks about [总结主旨].', slots: ['总结主旨'] },
    ],
    example: [
      ...
      { label: 'X 轴', text: 'The x-axis talks about the age group between 10 to 49.' },
      { label: 'Y 轴', text: 'The y-axis talks about the hours per day from 0 to 12 across four different categories such as social media, gaming, work or study, and other.' },
      { label: '细节一', text: 'It is evident that 10 to 19 years of age have at least 4 hours a day going into social media.' },
      { label: '细节二', text: '20 to 29 age group people at least have spent 6 hours per day on gaming.' },
      { label: '细节三', text: 'And 30 to 39 age group have spent almost 8 to 9 hours towards work or study.' },
      { label: '总结', text: 'Overall, this image talks about daily screen time by age group in hours per day.' },
    ],
    tips: [
      'Area chart 与 line graph 结构相同，X/Y 轴都必须说',
      '重点说面积最大/最小的类别及其对应人群',
      '可用 "dominates", "takes up the most area" 描述大面积区域',
      '多个类别时，选2-3个最突出的描述即可',
    ],
  },
  {
    ...
    imageSrc: '/di/bar.png',
    parts: [
      { label: '主题句', template: 'The image is a bar chart that gives information about [主题].', slots: ['主题'] },
      { label: 'X 轴', template: 'The x-axis talks about [X轴内容].', slots: ['X轴内容'] },
      { label: 'Y 轴', template: 'The y-axis talks about [Y轴内容] such as [类别列表].', slots: ['Y轴内容', '类别列表'] },
      { label: '细节一（第一组）', template: 'First, it is evident that [第一组最高/最低数据描述].', slots: ['第一组最高/最低数据描述'] },
      { label: '细节二（对比组）', template: 'With respect to [对比类别], [对比数据描述].', slots: ['对比类别', '对比数据描述'] },
      { label: '总结', template: 'Overall, this image talks about [总结].', slots: ['总结'] },
    ],
    example: [
      { label: '主题句', text: 'The image is a bar chart that gives information about publication of three universities across humanities, science and arts.' },
      { label: 'X 轴', text: 'The x-axis talks about the number of publications from zero to 80.' },
      { label: 'Y 轴', text: 'The y-axis talks about the location such as Birmingham, York, Middlesex and Warwick.' },
      { label: '细节一（Birmingham）', text: 'First, it is evident that Birmingham has approximately 60 publications in humanities, 40 in science, and above 80 in arts.' },
      { label: '细节二（Middlesex）', text: 'With respect to Middlesex, it has only less than 20 publications in science, 40 in humanities, and close to 30 in arts.' },
      { label: '总结', text: 'Overall, this image talks about the publication counts of four universities across three subject areas.' },
    ],
    tips: [
      '按组（类别）分组描述，每组说最高和最低即可',
      '数字用 approximately / around / close to 修饰，不必精确',
      'Horizontal bar chart 的 X/Y 轴描述方向互换',
      '若条形太多，选最突出的2-3组重点描述',
    ],
  },
  {
    ...
    parts: [
      { label: '主题句', template: 'The image is a line graph that talks about [主题].', slots: ['主题'] },
      { label: 'X 轴', template: 'The x-axis talks about [X轴内容].', slots: ['X轴内容'] },
      { label: 'Y 轴', template: 'The y-axis talks about [Y轴内容].', slots: ['Y轴内容'] },
      { label: '最低值', template: 'It is evident that [最低值时间/位置] has the least, the value of [最低值].', slots: ['最低值时间/位置', '最低值'] },
      { label: '最高值', template: 'Conversely, [最高值描述], that is [峰值] between [时间范围].', slots: ['最高值描述', '峰值', '时间范围'] },
      { label: '中间值', template: 'On the other hand, [中间值描述] between [时间范围].', slots: ['中间值描述', '时间范围'] },
      { label: '总结', template: 'Overall, this image talks about [总结].', slots: ['总结'] },
    ],
    example: [
      { label: '主题句', text: 'The image is a line graph that talks about probability of depression.' },
      { label: 'X 轴', text: 'The x-axis talks about the age between 16 to 52.' },
      { label: 'Y 轴', text: 'The y-axis talks about depression probability in percentage from 20 to 100.' },
      { label: '最低值', text: 'It is evident that the depression is at its least, the value of only 20, between the age of 16 to 18 and at the age of 50 to 52.' },
      { label: '最高值', text: 'Conversely, the probability of depression is the highest, that is 100%, between the age of 32 to 34.' },
      { label: '中间值', text: 'On the other hand, the probability of depression is between 60 to 65 between the age of 24 to 26 and 42 to 44.' },
      { label: '总结', text: 'Overall, this image talks about probability of depression across different ages.' },
    ],
    tips: [
      '趋势词汇：rises sharply / drops gradually / peaks at / reaches its lowest point / fluctuates',
      '多条线时，每条线单独描述，用颜色或名称区分',
      '重点说转折点（peak / trough）和整体趋势方向',
      '用 "between X and Y" 描述数值范围，而非精确单点',
    ],
  },
  {
    id: 'pie',
    ...
    imageSrc: '/di/pie.png',
    parts: [
      { label: '主题句', template: 'The image is a pie chart that gives information about [主题].', slots: ['主题'] },
      { label: '分类（替代轴）', template: 'There are [N] different categories such as [类别列表].', slots: ['N', '类别列表'], note: 'Pie chart 无 X/Y 轴，用此句替代' },
      { label: '最大占比', template: 'It is evident that the highest [类别描述] is [类别名], with an estimated value of [值].', slots: ['类别描述', '类别名', '值'] },
      { label: '第二大', template: 'Second highest is [类别] with [值].', slots: ['类别', '值'] },
      { label: '其余', template: 'The third is [类别], approximately [值], and the last is [类别] with [值].', slots: ['类别', '值', '类别', '值'] },
      { label: '总结', template: 'Overall, this image talks about [总结].', slots: ['总结'] },
    ],
    example: [
      { label: '主题句', text: 'The image is a pie chart that gives information about population age structures in India in 2025, estimated in crores.' },
      { label: '分类', text: 'There are four different categories such as children, adults, middle aged and youth.' },
      { label: '最大占比', text: 'It is evident that the highest population contribution is from adults between the age of 25 to 54, with an estimated value of 62 crores.' },
      { label: '第二大', text: 'Second highest is children between zero to 14, with an estimated value of 34 crores.' },
      { label: '其余', text: 'The third is middle aged between 55 to 64, approximately 14 crores, and last is youth with 22 crores between the age of 15 to 24.' },
      { label: '总结', text: 'Overall, this image talks about population age structure in India in 2025.' },
    ],
    tips: [
      'Pie chart 没有 X/Y 轴，用 "There are N categories" 句替代',
      '按占比从大到小排序描述（最大→最小）',
  ...
  },
  {
    ...
    parts: [
      { label: '主题句+类别', template: 'The image is a table that gives information about [主题] across different categories such as [类别列表].', slots: ['主题', '类别列表'] },
      { label: '细节一', template: 'It is evident that in [行/列], [数据描述].', slots: ['行/列', '数据描述'] },
      { label: '细节二', template: 'In [行/列], [数据描述].', slots: ['行/列', '数据描述'] },
      { label: '细节三', template: 'In [行/列], [数据描述].', slots: ['行/列', '数据描述'] },
      { label: '总结', template: 'Overall, [总结观察].', slots: ['总结观察'] },
    ],
    example: [
      { label: '主题句+类别', text: 'The image is a table that gives information about smartphone market share in 2024 in percentage, across different categories such as Apple, Samsung, Xiaomi, OnePlus and others.' },
      { label: '细节一 (Q1)', text: 'It is evident that in quarter one, Samsung is the second highest with a value of 26% and Apple leads with 28%.' },
      { label: '细节二 (Q2)', text: 'In quarter two, Apple has gotten the highest share with a value of 30%, followed by Xiaomi at 19% and OnePlus at 9%.' },
      { label: '细节三 (Q3&Q4)', text: 'In quarter three, Apple has got 32%, which is the highest again. In quarter four, OnePlus is the least with 11%, while Apple leads at 29%.' },
      { label: '总结', text: 'Overall, Apple consistently maintained the highest market share throughout 2024.' },
    ],
    tips: [
      'Table 没有 X/Y 轴，直接在主题句中说明行列类别',
      '按行或按列有序描述，不要跳跃',
      '重点读最高值、最低值，以及有意思的对比',
      '注意单位（%、$、人数），在第一次提到时说清楚',
    ],
  },
  {
    ...
    parts: [
      { label: '主题句', template: 'The image is a process that gives information about [主题].', slots: ['主题'] },
      { label: '步骤总数', template: 'It has [N] steps.', slots: ['N'] },
      { label: '步骤一', template: 'Step one, [第一步描述].', slots: ['第一步描述'] },
      { label: '步骤二', template: 'Step two, [第二步描述].', slots: ['第二步描述'] },
      { label: '步骤三+', template: '[后续步骤依次描述，用 then / next / after that 连接].', slots: ['后续步骤描述'], note: '根据实际步骤数量灵活扩展' },
      { label: '总结', template: 'Overall, this image talks about [主题] with [N] steps, starting from [第一步] and ending with [最后步].', slots: ['主题', 'N', '第一步', '最后步'] },
    ],
    example: [
      { label: '主题句', text: 'The image is a process that gives information about how a car starts.' },
      { label: '步骤总数', text: 'It has five steps.' },
      { label: '步骤一', text: 'Step one, you need to press the clutch.' },
      { label: '步骤二', text: 'Step two, at the same time you need to put in the keys and turn them to the right direction.' },
      { label: '步骤三&四', text: 'The third step involves changing the gear. Once you change the gear, you immediately go to step four where you put your hands on the steering wheel to steer in the required direction.' },
      { label: '步骤五', text: 'The fifth and final step is when the car moves, once all prior steps are done correctly.' },
      { label: '总结', text: 'Overall, this image talks about how a car starts with five steps: press the clutch, insert keys, change gear, hands on wheel, and the car moves.' },
    ],
    tips: [
      '先说总步数，再逐步描述，顺序清晰',
      '连接词：first / then / next / after that / once ... / finally',
      '不需要每个细节，说清楚顺序和关键动作即可',
      '总结句可将所有步骤快速串一遍（keyword list 形式）',
    ],
  },
  {
    id: 'map',
    ...
    imageSrc: '/di/map.png',
    parts: [
      { label: '主题句', template: 'The image is a map that gives information about [主题] across [N] different [地区类型] such as [地区列表].', slots: ['主题', 'N', '地区类型', '地区列表'] },
      { label: '最低值', template: 'It is evident that [地区] is the least with a value of [值].', slots: ['地区', '值'] },
      { label: '最高值', template: '[地区] is the highest with a value of [值].', slots: ['地区', '值'] },
      { label: '其余地区', template: '[地区] stands with [值], and [地区] has a value of [值].', slots: ['地区', '值', '地区', '值'] },
      { label: '总结', template: 'Overall, this image talks about [总结].', slots: ['总结'] },
    ],
    example: [
      { label: '主题句', text: 'The image is a map that gives information about urbanization rate by province in percentage across four different provinces such as Xinjiang, Sichuan, Beijing and Inner Mongolia.' },
      { label: '最低值', text: 'It is evident that Sichuan is the least with a value of 77.2%.' },
      { label: '最高值', text: 'Beijing is the highest with a value of 89.3% urbanization rate.' },
      { label: '其余地区', text: 'Xinjiang stands with 87.8%, and Inner Mongolia is the second lowest with a value of 64.1%.' },
      { label: '总结', text: 'Overall, this image talks about urbanization rate by province in percentage across China.' },
    ],
    tips: [
      'Map 无 X/Y 轴，直接说地区名称和对应数值',
      '按数值高低排序描述（最高→最低 或 最低→最高）',
  ...
  },
  {
    ...
    parts: [
      ...
      { label: '主要观察', template: 'It is evident that [最明显的场景描述].', slots: ['最明显的场景描述'] },
      { label: '推断', template: 'Looks like [根据场景的合理推断].', slots: ['根据场景的合理推断'] },
      { label: '对比细节', template: 'Conversely, I can also see that [另一个对比性细节].', slots: ['另一个对比性细节'] },
      { label: '具体细节', template: 'Also, I could see that [具体人物/物体/动作描述].', slots: ['具体人物/物体/动作描述'] },
      { label: '总结', template: 'Overall, this image shows [总结印象].', slots: ['总结印象'] },
    ],
    example: [
      { label: '主题句', text: 'The image is a picture that gives information about a metro train station in some foreign country.' },
      { label: '主要观察', text: 'It is evident that there are people going in and there are people going out.' },
      { label: '推断', text: 'Looks like the train has just arrived, taking people in while some who need to get out are just stepping off.' },
      { label: '对比细节', text: 'Conversely, I can also see that a very limited number of people exist in the station.' },
      { label: '具体细节', text: 'Also, I could see that one person with a jacket is entering the metro station and there are one or two ladies coming out.' },
      { label: '总结', text: 'Overall, this image shows a relatively quiet metro train station with a small number of commuters.' },
    ],
    tips: [
      'Photo 无数据/轴，用观察和合理推断替代数据描述',
      '"It is evident that..." 用于描述明显可见的内容',
      '"Looks like..." 表达推断，适合不确定时使用',
      '可描述：人物动作、颜色、位置、数量、氛围',
      '不要沉默：I can also see / Another thing I notice is / It appears that',
    ],
  },
]
...
export const SGD_TEMPLATE: SimpleTemplate = {
  ...
  parts: [
    ...
    { label: 'Speaker 1 — 观点', text: 'First, speaker 1 was of the opinion that [观点A]. Then, speaker 1 said that [补充观点]. In addition, speaker 1 was of the view that [延伸观点].', slots: ['观点A', '补充观点', '延伸观点'] },
    { label: 'Speaker 2 — 观点', text: 'Next, speaker 2 mentioned that [观点B]. It was noted that [关键信息]. Furthermore, speaker 2 said that [额外细节].', slots: ['观点B', '关键信息', '额外细节'] },
    { label: 'Speaker 3 — 观点 (可选)', text: 'Speaker 3 told [观点C], it was important to note that [关键点]. Then, speaker 3 also noted that [补充].', slots: ['观点C', '关键点', '补充'] },
    { label: '总结', text: 'In the end, [总结共识或主要结论].', slots: ['总结共识或主要结论'] },
  ],
  tips: [
    '时间：10秒准备，90秒录音',
    '边听边记每位说话者的核心观点（不需要全部细节）',
    '用 "speaker 1/2/3" 区分，不必记名字',
    '每位说话者用2-3句描述即可',
    '不需要表达个人观点，只需客观总结',
    '注意区分 "said/mentioned/was of the opinion/noted" 等报告动词',
  ],
}
...
export const RL_TEMPLATE: SimpleTemplate = {
  ...
  label: 'RL 模板（新版）',
  parts: [
    { label: '主题句', text: 'The lecture discusses [主题/话题].', slots: ['主题/话题'] },
    { label: '开头', text: 'In the beginning, the speaker explained about [开头要点].', slots: ['开头要点'] },
    { label: '发展', text: 'Later, the speaker said [中间要点].', slots: ['中间要点'] },
    { label: '延伸', text: 'Here, the speaker also mentioned [补充信息].', slots: ['补充信息'] },
    { label: '结语', text: 'In conclusion, the lecture effectively summarized [总结/结论].', slots: ['总结/结论'] },
  ],
  tips: [
    '时间：10秒准备，40秒录音',
    '边听边在草稿纸上记3-5个关键词',
    '不需要复述所有细节，抓主旨和1-2个要点即可',
    '开头句要清晰说出 "The lecture discusses..."',
    '用过去时（said, explained, mentioned, discussed）',
    '流畅度比内容量更重要',
  ],
}
...
export const RTS_TEMPLATE: SimpleTemplate = {
  ...
  label: 'RTS 模板',
  parts: [
    { label: '开场（问候+引入）', text: "Hi! I would like to discuss an issue we have encountered with [话题/关键词].", slots: ['话题/关键词'] },
    { label: '背景陈述', text: 'The background is that [复述题目中的情境信息].', slots: ['情境信息'] },
    { label: '建议一', text: 'In this situation, what I can think of is to [具体行动一].', slots: ['具体行动一'] },
    { label: '建议二', text: 'Besides, another thing that comes to my mind is to [具体行动二].', slots: ['具体行动二'] },
  ],
  tips: [
    '时间：20秒准备，40秒录音',
    '语气要自然友好，像在真实对话中',
    '两个建议要具体、可执行',
    '注意题目的语境：是向朋友、同事还是客户讲话？',
    '发音和流畅度是主要评分维度',
    '可以稍微延伸每个建议，增加细节',
  ],
}
