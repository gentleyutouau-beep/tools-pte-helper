...
export const DI_TYPE_TEMPLATES: DITypeTemplate[] = [
  {
    ...
    parts: [
      ...
      { label: '最低值', template: 'In contrast, [最低值/最不明显的数据].', slots: ['最低值/最不明显的数据'] },
      { label: '中间值', template: 'Meanwhile, [中间值/另一个重要数据].', slots: ['中间值/另一个重要数据'] },
    ...
    example: [
      ...
      { label: '最低值', text: 'In contrast, the 40 to 49 age group shows the lowest figure for gaming, at around 1 hour per day.' },
      { label: '中间值', text: 'Meanwhile, the 20 to 29 age group spends about 6 hours per day on gaming.' },
  ...
  },
  {
    ...
    example: [
      ...
      { label: '最低值', text: 'In contrast, Middlesex has the lowest figure in science, at less than 20 publications.' },
      { label: '中间值', text: 'Meanwhile, York records around 50 publications in humanities.' },
  ...
  },
  {
    ...
    example: [
      ...
      { label: '最低值', text: 'In contrast, it shows the lowest figure of 20% between the ages of 16 and 18 and also from 50 to 52.' },
      { label: '中间值', text: 'Meanwhile, the probability is around 60 to 65% between the ages of 24 and 26 and 42 and 44.' },
  ...
  },
  {
    ...
    parts: [
      ...
      { label: '最低值', template: 'In contrast, [最低值/最小占比/最不明显的数据].', slots: ['最低值/最小占比/最不明显的数据'] },
      { label: '中间值', template: 'Meanwhile, [中间值/另一个重要数据].', slots: ['中间值/另一个重要数据'] },
      { label: '总结', template: 'Overall, this image mainly talks about [总结主旨].', slots: ['总结主旨'] },
    ],
    example: [
      ...
      { label: '最低值', text: 'In contrast, middle-aged people aged 55 to 64 have the lowest figure, at 14 crores.' },
      { label: '中间值', text: 'Meanwhile, children aged 0 to 14 show 34 crores.' },
  ...
  },
  {
    ...
    example: [
      ...
      { label: '最低值', text: 'In contrast, OnePlus has the lowest figure in quarter one, at 8%.' },
      { label: '中间值', text: 'Meanwhile, Samsung records 26% in quarter one, which is between the highest and lowest figures.' },
  ...
  },
  {
    ...
    example: [
      ...
      { label: '最低值', text: 'In contrast, Inner Mongolia has the lowest figure, at 64.1%.' },
      { label: '中间值', text: 'Meanwhile, Sichuan records 77.2%, which is between the highest and lowest figures.' },
  ...
  },
  {
    ...
    parts: [
      { label: '主题句', template: 'The picture is about [主题/场景]. According to the picture, we can see many things.', slots: ['主题/场景'] },
    ...
    example: [
      { label: '主题句', text: 'The picture is about a metro train station. According to the picture, we can see many things.' },
